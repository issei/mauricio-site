<!-- Generated by scripts/i18n/translate.py from public/devin.md. Do not edit by hand: the next sync overwrites it. -->
# Vibe Coding com Devin — De Executor a Orquestrador Cognitivo

> Versão Markdown (GEO/AEO) de <https://mauricio.issei.com.br/en/devin>. Autor: **Maurício Yokoyama Issei** · pt-BR · Publicado: 2026-05-19 · Atualizado: 2026-06-21.

## Em síntese

O **Vibe Coding** maduro não é caos de prompts: é **intenção estruturada e persistente**. O humano sobe de executor a **Orquestrador Cognitivo** — dirige a inteligência da máquina com intenção clara, como um chef executivo que garante que cada prato saia certo sem cozinhar todos.
...
No SDD a especificação é a fonte da verdade: escreve-se o quê e o porquê, e a IA implementa contra a spec com testes (BDD) como alvo objetivo. Quando a intenção vive num prompt descartável ela se perde; quando vive numa spec no repositório, ela escala e é auditável.
...
- **SDD (Spec-Driven Development)** — A especificação como fonte da verdade; a IA implementa contra a spec, com testes como alvo.
