...
:: ID da distribuição CloudFront vem do ambiente — repo público, ver docs/AGENT_READINESS.md §3
if not defined DISTRIBUTION_ID echo ❌ Defina DISTRIBUTION_ID ^(set DISTRIBUTION_ID=...^). Abortando. & exit /b 1
