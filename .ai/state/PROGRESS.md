...
| WU-4 | ⬜ next | Jornada (estrutura dos 10 capítulos) | 02 | Sonnet |
...
## Próxima ação
Iniciar **WU-4** (Jornada): estrutura dos 10 capítulos (accordion/stepper) com objetivo+resumo por
capítulo, a partir do doc 02.
